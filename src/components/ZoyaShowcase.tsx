      ...
      {showSwitcherTrigger && (
        <div className="absolute right-5 top-5 z-20 flex flex-col items-end">
          <div className="flex items-center gap-2">
            ...
            >
              {/* Just "Projects": the client's name is already the wordmark beside it, and
                  "O West Projects" read as if O West were the developer, not the site. */}
              Projects {switcherOpen ? "▴" : "▾"}
            </button>
          </div>
